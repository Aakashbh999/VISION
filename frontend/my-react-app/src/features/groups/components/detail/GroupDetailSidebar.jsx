...
import { Users, ArrowUpRight, Circle, Settings } from "lucide-react";
...
const GroupDetailSidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 w-80 bg-[var(--bg-card)] border-l border-[var(--border-main)] border-y md:border-y-0 transform transition-transform duration-300 ease-in-out lg:static lg:transform-none lg:flex flex-col flex ${
          ...
          <>
            <header className="h-20 px-8 flex items-center justify-between border-b border-[var(--border-main)] bg-[var(--bg-card)] shadow-sm z-10">
              <span className="text-xs font-black text-[var(--text-main)] uppercase tracking-widest flex items-center gap-2">
                <Users className="w-4 h-4 text-purple-600" /> Online Members
              </span>
            ...
            <Link
              ...
              className="flex items-center gap-3 mx-4 mt-4 mb-2 p-3 rounded-sm sm:rounded-2xl border border-[var(--border-main)] hover:border-purple-200 hover:bg-purple-50/50 transition-all group/glink"
            >
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-1">
                  {onlineMembers.length > 0 ? (
                    ...
                    <p className="text-xs text-[var(--text-muted)] font-medium px-2 py-3">
