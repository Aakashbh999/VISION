                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          <p
                            className={`text-sm font-black truncate ${achieved ? `${m.light.split(" ")[0]} ${m.dark.split(" ")[0]}` : "text-[var(--text-muted)]"}`}
                          >
                            {m.label}
                          </p>
                          <p
                            className={`text-xs font-bold leading-tight ${achieved ? `${m.light.split(" ")[0]} ${m.dark.split(" ")[0]}` : "text-[var(--text-muted)]"}`}
                          >
                            {achieved ? (
