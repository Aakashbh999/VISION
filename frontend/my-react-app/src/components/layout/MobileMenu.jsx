import { X, Home, BookOpen, Briefcase, Users, GraduationCap, BarChart, MessageCircle, Users2, FolderOpen, User } from "lucide-react";
            ...
            <nav className="space-y-4 mt-8">
              {portalNavItems.map((item) => (
                <Link
                  ...
                  to={item.href}
                  onClick={onClose}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-[var(--bg-active)] text-[var(--text-muted)] hover:text-purple-600 dark:hover:text-purple-400 hover:font-medium hover:border hover:border-[var(--border-main)] transition-all duration-300 w-full text-left"
                >
