            ...
            <tbody className="divide-y divide-border-main/50">
              {filteredLogs.length === 0 ? (
                <tr>
                  <td
                    colSpan="5"
                    className="px-6 py-20 text-center text-text-muted font-medium italic"
                  >
                    {searchTerm
                      ? "No logs matching your search on this page."
                ...
                filteredLogs.map((log, idx) => (
                  ...
                  >
                    <td className="px-6 py-5 whitespace-nowrap">
                      <code className="text-[11px] font-black text-text-muted opacity-60">
                        #{log.log_id}
                      </code>
                    </td>
                    <td className="px-6 py-5 whitespace-nowrap">
                    ...
                    <td className="px-6 py-5 whitespace-nowrap">
                      <div
                        className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-black uppercase border tracking-wider ${getActionBg(log.action_type)}`}
                      >
        ...
        {pagination.totalPages > 1 && (
          <div className="px-6 py-6 border-t border-border-main flex items-center justify-between">
            <p className="text-xs font-bold text-text-muted">
              Showing <span className="text-text-main">{logs.length}</span>{" "}
