...
const EditDiscussion = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
      {/* Header */}
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold text-[var(--text-main)]">Edit Discussion</h1>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-[var(--bg-main)] text-[var(--text-main)] ${
                errors.specializationId ? "border-red-500" : "border-[var(--border-main)]"
              }`}
            >
          ...
          <div>
            <label className="block text-sm font-medium text-[var(--text-main)] mb-1">
              Degree <span className="text-[var(--text-muted)]">(optional)</span>
            </label>
            <select
              name="degreeId"
