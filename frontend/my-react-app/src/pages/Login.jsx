          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-[var(--border-main)] rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none bg-[var(--bg-main)] text-[var(--text-main)]"
