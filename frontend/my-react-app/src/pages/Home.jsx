...
const Home = () => {
  return (
    <div className="space-y-12 sm:space-y-16 lg:space-y-20">
      ...
      <section className="max-w-4xl mx-auto text-center py-8 sm:py-10 lg:py-12 rounded-2xl lg:rounded-3xl bg-gradient-to-br from-white to-gray-50 border border-gray-200 hover:shadow-lg transition-shadow duration-500">
